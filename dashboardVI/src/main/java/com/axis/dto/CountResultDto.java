...
public class CountResultDto {
	...
	public static class Customers {
		private String name;
		private String principalPaymentDueDate;
		...
		public String getPrincipalPaymentDueDate() {
			return principalPaymentDueDate;
		}
		public void setPrincipalPaymentDueDate(String principalPaymentDueDate) {
			this.principalPaymentDueDate = principalPaymentDueDate;
		}
